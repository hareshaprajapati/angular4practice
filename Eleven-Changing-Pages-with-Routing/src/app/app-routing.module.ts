...
const appRoutes: Routes = [
  ...
  {path: 'servers',
    ...
    component: ServersComponent, children:[
      ...
      {path: ':id/edit', component: EditServerComponent, canDeactivate: [CanDeactivateAuthGuardService]}
    ]},
  // {path: 'not-found' , component: PageNotFoundComponent},
  {path: 'not-found' , component: ErrorPageComponent, data : {'message' : 'Something went wrong!!!'}},
